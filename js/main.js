...
document.addEventListener('DOMContentLoaded', function(){
  ...
  if(details && typeof SERVICES !== 'undefined'){
    ...
    var leftHtml = '<div style="display:flex;flex-direction:column;gap:24px"><h1>'+s.title+'</h1><p style="margin:0;color:#666">'+(s.longDescription||'')+'</p>'+featuresHtml+customSection+faqContent+'</div>';
