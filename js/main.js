...
document.addEventListener('DOMContentLoaded', function(){
  ...
  if(details && typeof SERVICES !== 'undefined'){
    ...
    var leftHtml = '<div><h1>'+s.title+'</h1><p style="margin-top:12px;color:#666">'+(s.longDescription||'')+'</p>'+featuresHtml+'</div>';
    var bottomHtml = '<div style="margin-top:32px">'+customSection+faqContent+'</div>';
    ...
    details.innerHTML = '<div class="details-layout">'+leftHtml+rightHtml+'</div>'+bottomHtml;
  }
